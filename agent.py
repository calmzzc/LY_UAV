...
class DDPG:
    ...
    def choose_action(self, state, flag):
    ...
    def save_mid(self, path):
        torch.save(self.actor.state_dict(), path + 'mid_checkpoint.pt')

    def load_mid(self, path):
        self.actor.load_state_dict(torch.load(path + 'mid_checkpoint.pt'))
